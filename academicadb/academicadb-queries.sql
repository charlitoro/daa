...
-- Clasificar los estudiantes del departamento de nari̱o en los estratos BAJO(1,2), MEDIO(3,4), Alto(5,6).
...
----------
-- Visualizar las mujeres de estratos MEDIO del depratamento de nari̱o
